                    ...
                    <div class="card card-body">
                       <h3>ADD NEW MOVIE</h3>
                        <table class="table text-black mt-4 text-center" cellspacing="5"
                            ...
                            <tr>
                                <th>Title</th>
                                <td><input type="text" class="" id="inputTitle" name="title" value="" autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th>Duration</th>
                ...
                <div class="collapse mt-2 text-black" id="manageStudios">
                    <div class="card card-body">
                        ...
                        <table class="table text-black mt-4 text-center" cellspacing="5"
                            ...
                            <tr>
                                <th>Number</th>
                                <td><input type="text" class="" id="inputNumber" name="number" value="" autocomplete="off"></td>
                            </tr>
                            <tr>
                                <th>Capacity</th>
                            ...
                            <tr>
                                <th>&nbsp;</th>
                                <td><input type="button" class="btn btn-primary" id="buttonStudioMovie" name="addStudioButton" value="Add Studio"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
